...
import ClientGrid from '@/app/components/Moderator/Manage/ClientGrid';
...
const ManageClients: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchApi(`${process.env.NEXT_PUBLIC_API_URL}/clients`)
      .then(data => {
...
export default withAuth(ManageClients, ['moderator']);
