...
import MailboxConfiguration from '@/app/components/MasterAdmin/ITConfig/MailboxConfig';
import AssignAdmin from '@/app/components/MasterAdmin/ITConfig/AssignAdmin';
